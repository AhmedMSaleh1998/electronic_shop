    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-xs-6">
                <div class="shop">
                    <div class="shop-img">
                        <img src="images/departments/{{ $dept->image }}" alt="" width="215px" height="280px">
                    </div>
                    <div class="shop-body">
                        <h3>{{ $dept->name }}<br>Collection</h3>
                        <a href="{{ route('departmentProducts',$dept->id) }}" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </div>
            <!-- /shop -->
                            ...
                            <div class="products-slick" data-nav="#slick-nav-1">
                                ...
                                <div class="product">
                                    <div class="product-img">
                                        <img src="images/products/{{ $prod->image }}" alt="" width="280" height="255">
